        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg bg-light">
                <div className="container-fluid rr" style={{display:"flex"}}>
                    ...
                    <button className="navbar-toggler dispHB" style={{marginTop:"-35px"}} type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
