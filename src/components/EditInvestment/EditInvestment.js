...
export default function EditInvestment() {
  ...
  const singleInvestmentData = async () => {
    ...
    await fetch(`https://localhost:7214/api/Investment/GetSingleInvestment/${infoID}/${strtID}`, {
      method: 'GET',
      headers: {
...
let noc = "nochange";
  ...
  const Formik = useFormik({
    ...
    onSubmit: (values, action) => {
      ...
      try {
        ...
        fetch(`https://localhost:7214/api/Investment/advisorUpdateinvestment/${infoID}/${strtID}/${advId}`, {
          method: 'PUT',
          headers: {
            'Content-type': 'application/json',
            "Access-Control-Allow-Origin": "*",
  ...
  return (
    <>
      ...
      <div className='col-4' style={{marginLeft: "20px",width:"360px"}}>
      ...
      <div className='col-4' style={{marginLeft: "40px",width:"360px"}}>
